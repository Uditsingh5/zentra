...
const HomeTab = () => {
    return (
        <div className="max-w-3xl my-2 px-2 py-2 mx-auto text-gray-500 flex justify-between items-center select-none">
            ...
            <button
                className={`bg-[#CE97FF] cursor-pointer text-gray-700 hover:text-gray-600 px-6 py-2 rounded-2xl`}
            >
                Post
            </button>
        </div>
...
const Home = () => {
    ...
    return (
        <div className="w-full rounded-lg flex gap-1">
            <NewPost  triggerRef={postButtonRef} />
            
            {/* Main Feed */}
            <div className="h-auto basis-3/4 border-r border-gray-200">
                <HomeTab />
                <pre className="text-xs bg-gray-800 p-2 rounded text-white">
                    ...
                    profiles={[
                        {
                            ...
                            mutuals: "Followed by xyz",
                            avatar: "https://i.pravatar.cc/100?img=12",
                        },
                        {
                            id: 2,
                            username: "Thakur._.",
                            mutuals: "Followed by abc",
                            avatar: "https://i.pravatar.cc/100?img=68",
                        },
                        {
                            id: 3,
                            username: "Thakur.Yuvi",
                            mutuals: "Followed by def",
